...
pivot_std['bank_stoerrelse'] = pd.Categorical(pivot_std['bank_stoerrelse'], categories=kategori_ordning, ordered=True)
...
sns.boxplot(data=pivot_std, x='bank_stoerrelse', y='residuals', palette=palette)
